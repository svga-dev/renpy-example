...
define config.name = _("TheStanfordAcceptanceSimulator")
...
define build.name = "TheStanfordAcceptanceSimulator"
...
define config.save_directory = "TheStanfordAcceptanceSimulator-1541124979"
